...
define('ember-app/mixins/regenerated/models/i-i-s-a-z-s-kursach-\u0447\u0435\u043A', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ЧекE', 'i-i-s-a-z-s-kursach-чек', {
      ...
      клиент: (0, _attributes.belongsTo)('i-i-s-a-z-s-kursach-клиент', 'ФИО клиента', {}, { index: 1, displayMemberPath: 'наимен' }),
      заправкаАвто: (0, _attributes.belongsTo)('i-i-s-a-z-s-kursach-заправка-авто', 'Заправка автомобиля', {}, { index: 3, displayMemberPath: 'колТоп' }),
    ...
    modelClass.defineProjection('ЧекL', 'i-i-s-a-z-s-kursach-чек', {
      ...
      клиент: (0, _attributes.belongsTo)('i-i-s-a-z-s-kursach-клиент', 'ФИО клиента', {
        наимен: (0, _attributes.attr)('ФИО клиента', { index: 1 })
      }, { index: -1, hidden: true }),
      сумма: (0, _attributes.attr)('Сумма', { index: 2 }),
      заправкаАвто: (0, _attributes.belongsTo)('i-i-s-a-z-s-kursach-заправка-авто', 'Количество топлива', {
        колТоп: (0, _attributes.attr)('Количество топлива', { index: 3 })
      }, { index: -1, hidden: true })
    });
  };
});
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-a-z-s-kursach-чек': 'id,номер,сумма,заправкаАвто,клиент,*тЧТовары'
      });
